...
/******/ ;(() => {
  ...
  ;(() => {
    ...
    var reading_time = __nccwpck_require__(820) // CONCATENATED MODULE: external "util"
    const external_util_namespaceObject = require('util') // CONCATENATED MODULE: ./src/getFile.mjs
    ...
    async function countReadingTimeByContent(path) {
      ...
      const readingTimeResult = reading_time(content.toString())
      return {
        ...readingTimeResult,
    ...
    async function calculateRoutesReadingTime(routes) {
    ...
    async function run() {
      try {
        ...
        ;(0, external_fs_.writeFileSync)(manifestPath, newManifest)

        const statResult = (0, external_fs_.statSync)(manifestPath)
